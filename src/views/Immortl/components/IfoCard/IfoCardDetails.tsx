...
import { usePriceBnbBusd, usePriceCakeBusd, usePrices } from 'state/hooks'
...
const IfoCardDetails: React.FC<IfoCardDetailsProps> = ({
  ...
  const onePriceString = onePrice.toLocaleString()
  const saleTokenPrice = new BigNumber(wonePrice).times(onePrice).toNumber().toLocaleString('en-us', { maximumFractionDigits: 5, minimumFractionDigits: 3 })
